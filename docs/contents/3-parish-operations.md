...
See [‘Religious order–administered parishes’ below](#religious-order%E2%80%93administered-parishes) for further details on what happens when the pastoral care of a parish is assigned to a religious order and one of their clergy is appointed parish priest.
